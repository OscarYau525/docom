...
def get_args():
    ...
    parser.add_argument("--gcloud_bucket", default=None, type=str)
    ...
    parser.add_argument("--eval_freq", type=int, default=196)
    ...
    parser.add_argument("--beta_change_epochs", type=str, default=None)
    ...
    parser.add_argument("--beta_decay", type=float, default=10)
